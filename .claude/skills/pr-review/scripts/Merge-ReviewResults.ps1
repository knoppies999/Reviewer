...
[void]$sb.AppendLine()
[void]$sb.AppendLine('_Generated by the pr-review skill: a subagent per changed file (files with tiny diffs share one), a contracts pass alongside them, and a verification pass after. Findings marked "unverified" need a human look._')
